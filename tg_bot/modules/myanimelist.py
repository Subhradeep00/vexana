...
ANIME_HANDLER = CommandHandler("yanime", anime, run_async=True)
CHARACTER_HANDLER = CommandHandler("ycharacter", character, run_async=True)
UPCOMING_HANDLER = CommandHandler("yupcoming", upcoming, run_async=True)
MANGA_HANDLER = CommandHandler("ymanga", manga, run_async=True)
