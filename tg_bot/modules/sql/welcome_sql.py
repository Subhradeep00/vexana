...
DEFAULT_WELCOME_MESSAGES = [
    "Hi, {first}, show me your Hunter License!",  # Discord welcome messages copied
    ...
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",  # Corona memes lmao
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    ...
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",  # One Piece Sanji
    "Hi, {first}, show me your Hunter License!",  # No Game No Life
    "Hi, {first}, show me your Hunter License!",  # No Game No Life
    "Hi, {first}, show me your Hunter License!",  # Steins Gate
    "Hi, {first}, show me your Hunter License!",  # weeabo shit
    "Hi, {first}, show me your Hunter License!",  # tokyo ghoul
    "Hi, {first}, show me your Hunter License!",  # hunter x hunter
    "Hi, {first}, show me your Hunter License!",  # one Piece
    "Hi, {first}, show me your Hunter License!",  # BNHA
    "Hi, {first}, show me your Hunter License!",  # Kamina Falls – Gurren Lagann
    "Hi, {first}, show me your Hunter License!",  # Hellsing
    "Hi, {first}, show me your Hunter License!",  # Neon Genesis: Evangelion
    "Hi, {first}, show me your Hunter License!",  # Pokemon
    "Hi, {first}, show me your Hunter License!",  # Shaggy
    "Hi, {first}, show me your Hunter License!",  # jojo
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",
    "Hi, {first}, show me your Hunter License!",  # Death Note owo
    "Hi, {first}, show me your Hunter License!",  # Death Note owo
    "Hi, {first}, show me your Hunter License!",  # Tokyo Ghoul
    "Hi, {first}, show me your Hunter License!",  # op
    "{first} joined!, Gate of View...open!",  # Op
    "{first} joined!, Gate of View...open!",
    "{first} joined!, Gate of View...open!",  # Naruto stuff begins from here
    "{first} joined!, Gate of View...open!",
    ...
    "{first} joined!, Gate of View...open!",
    "{first} joined!, Gate of View...open!",  # Kyuubi to naruto
    "{first} joined!, Gate of View...open!",  # Naruto thingies end here
    "{first} joined!, Gate of View...open!",  # Jumanji stuff
